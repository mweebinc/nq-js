...
describe("nameToNumber function", function () {
    ...
    it('should check all the name are the same', () => {
        ...
        const duplicates = {};
        const names2 = [
            {first_name: 'Ferdineil', last_name: 'Esguerra', birthdate: '4/24/1980'},
        ]
        let count = 0;
        names.forEach(entry => {
        ...
        const duplicateGroups = Object.values(duplicates).reduce((acc, group) => acc + group.length - 1, 0);
        ...
        console.log("Percentage of duplicates:", percentageOfDuplicates.toFixed(2) + "%");
    });
});
